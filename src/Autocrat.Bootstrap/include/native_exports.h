...
extern "C"
{
    ...
    extern void CDECL
    register_constructor(const void* type, std::int32_t handle);

    // Autocrat.NativeAdapters.TimerService::OnTimerTick
    extern std::int32_t CDECL register_timer(
